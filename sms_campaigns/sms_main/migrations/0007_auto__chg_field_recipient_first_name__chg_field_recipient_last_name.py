...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Recipient.first_name'
        db.alter_column(u'sms_main_recipient', 'first_name', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

        # Changing field 'Recipient.last_name'
        db.alter_column(u'sms_main_recipient', 'last_name', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

    def backwards(self, orm):

        # Changing field 'Recipient.first_name'
        db.alter_column(u'sms_main_recipient', 'first_name', self.gf('django.db.models.fields.CharField')(default='', max_length=256))

        # Changing field 'Recipient.last_name'
        db.alter_column(u'sms_main_recipient', 'last_name', self.gf('django.db.models.fields.CharField')(default='', max_length=256))
