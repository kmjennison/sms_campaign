...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'sms_main_userprofile', (
            ...
            ('isGroupManager', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('isCampaignManager', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('isAuthorizedEnroller', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sms_main.Group'], null=True)),
            ('campaign', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sms_main.Campaign'], null=True)),
        ))
