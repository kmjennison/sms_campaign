...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Recipient', fields ['phone_number']
        db.create_unique(u'sms_main_recipient', ['phone_number'])


    def backwards(self, orm):
        # Removing unique constraint on 'Recipient', fields ['phone_number']
        db.delete_unique(u'sms_main_recipient', ['phone_number'])
