...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'sms_main_userprofile', 'phone_number',
                      self.gf('phonenumber_field.modelfields.PhoneNumberField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.permitted_enroller'
        db.add_column(u'sms_main_userprofile', 'permitted_enroller',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'sms_main_userprofile', 'phone_number')

        # Deleting field 'UserProfile.permitted_enroller'
        db.delete_column(u'sms_main_userprofile', 'permitted_enroller')
