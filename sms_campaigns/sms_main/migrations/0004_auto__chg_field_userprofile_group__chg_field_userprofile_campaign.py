...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'sms_main_userprofile', 'group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sms_main.Group'], null=True))

        # Changing field 'UserProfile.campaign'
        db.alter_column(u'sms_main_userprofile', 'campaign_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sms_main.Campaign'], null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.group'
        db.alter_column(u'sms_main_userprofile', 'group_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['sms_main.Group']))

        # Changing field 'UserProfile.campaign'
        db.alter_column(u'sms_main_userprofile', 'campaign_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['sms_main.Campaign']))
    ...
    models = {
        ...
        u'sms_main.userprofile': {
            ...
            'campaign': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sms_main.Campaign']", 'null': 'True'}),
