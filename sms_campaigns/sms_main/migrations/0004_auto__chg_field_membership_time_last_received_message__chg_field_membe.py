...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Membership.time_last_received_message'
        db.alter_column(u'sms_main_membership', 'time_last_received_message', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Membership.no_response_contact'
        db.alter_column(u'sms_main_membership', 'no_response_contact', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'Membership.last_received_message'
        db.alter_column(u'sms_main_membership', 'last_received_message', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

    def backwards(self, orm):

        # Changing field 'Membership.time_last_received_message'
        db.alter_column(u'sms_main_membership', 'time_last_received_message', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Membership.no_response_contact'
        db.alter_column(u'sms_main_membership', 'no_response_contact', self.gf('django.db.models.fields.CharField')(default='hello', max_length=30))

        # Changing field 'Membership.last_received_message'
        db.alter_column(u'sms_main_membership', 'last_received_message', self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2014, 5, 17, 0, 0), max_length=256))
    ...
    models = {
        ...
        u'sms_main.userprofile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'isAuthorizedEnroller': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'isCampaignManager': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'isGroupManager': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
