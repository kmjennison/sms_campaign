...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'sms_main_userprofile', (
            ...
            ('isGroupManager', self.gf('django.db.models.fields.BooleanField')()),
            ('isCampaignManager', self.gf('django.db.models.fields.BooleanField')()),
            ('isAuthorizedEnroller', self.gf('django.db.models.fields.BooleanField')()),
    ...
    models = {
        ...
        u'sms_main.userprofile': {
            ...
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sms_main.Group']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'isAuthorizedEnroller': ('django.db.models.fields.BooleanField', [], {}),
            'isCampaignManager': ('django.db.models.fields.BooleanField', [], {}),
            'isGroupManager': ('django.db.models.fields.BooleanField', [], {}),
