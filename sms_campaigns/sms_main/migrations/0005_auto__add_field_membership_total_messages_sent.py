...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Membership.total_messages_sent'
        db.add_column(u'sms_main_membership', 'total_messages_sent',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Membership.total_messages_sent'
        db.delete_column(u'sms_main_membership', 'total_messages_sent')
