...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Recipient.phone_number'
        db.alter_column(u'sms_main_recipient', 'phone_number', self.gf('phonenumber_field.modelfields.PhoneNumberField')(max_length=128, null=True))

    def backwards(self, orm):

        # Changing field 'Recipient.phone_number'
        db.alter_column(u'sms_main_recipient', 'phone_number', self.gf('django.db.models.fields.CharField')(default='1234567890', max_length=30))
