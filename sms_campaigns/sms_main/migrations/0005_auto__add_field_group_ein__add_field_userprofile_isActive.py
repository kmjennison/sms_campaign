...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Group.ein'
        db.add_column(u'sms_main_group', 'ein',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=256),
                      keep_default=False)

        # Adding field 'UserProfile.isActive'
        db.add_column(u'sms_main_userprofile', 'isActive',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Group.ein'
        db.delete_column(u'sms_main_group', 'ein')

        # Deleting field 'UserProfile.isActive'
        db.delete_column(u'sms_main_userprofile', 'isActive')
    ...
    models = {
        ...
        u'sms_main.group': {
            'Meta': {'object_name': 'Group'},
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'ein': ('django.db.models.fields.CharField', [], {'default': '1', 'max_length': '256'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'})
        },
